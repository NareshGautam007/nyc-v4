...
<head>
    ...
    <title>Nyc Games | Bundle</title>
    <link rel="stylesheet" href="css/owl.carousel.min.css">
    <link rel="shortcut icon" href="assets/logo/fav.png" type="image/png">
    ...
    <div class="wrappage">
        <header id="header" class="header-v2">
            ...
            <!--<div class="header-top-banner">
                <a href="#"><img src="assets/img/banner-top.jpg" alt="" class="img-reponsive"></a>
            </div>-->
            <div class="topbar">
                ...
                <div class="container container-240">
                    <div class="row flex">
                        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6 v-center header-logo">
                            <a href="#"><img src="assets/logo/logo.png" alt="" class="img-reponsive"></a>
                        </div>
                        ...
                        <div class="col-lg-3  col-md-3 col-sm-6 col-xs-6 v-center header-sub">
                            <div class="right-panel">
                                ...
                                <div class="header-sub-element row">
                                    <a class="hidden-xs hidden-sm" href=""><img src="assets/img/icon-user.png" alt=""></a>
                                    <a href="#">
                                        <img src="assets/img/icon-user3.png" alt=""></a>
                                    <div class="cart">
                                            ...
                                            <ul class="mini-products-list">
                                                <li class="item-cart">
                                                    <div class="product-img-wrap">
                                                        <a href="#"><img src="assets/img/icon-user3.jpg" alt="" class="img-reponsive"></a>
                                                    </div>
            ...
            <div class="header-bottom hidden-xs hidden-sm">
                <div class="flex lr">
                    <div class="box-header-nav">
                        <nav class="main-menu">
                            <ul class="nav navbar-nav">
                                    ...
                                    <div class="menu-level-1 ver2 dropdown-menu">
                                        <div class="row">
                                            ...
                                            <div class="cate-item col-md-4 col-sm-12">
                                                ...
                                                <div class="demo-text">Consoles</div>
                                            </div>
                                ...
                                <li class="level1"><a href="#">Bundle Offers </a></li>
                                <li class="level1">
                                    <a href="#">Unboxing Videos <span class="h-ribbon h-pos v4 e-red">hot</span></a></li>
                                <li class="level1 nwhdr"><a href="#"> Reviews</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="box-header-menu">
                        <nav class="main-menu">
                            <ul class="nav navbar-nav">
                                <li class="level1"><a href="#">Blogs/Latest Updates</a></li>
                                <li class="level1"><a href="#">Tech Discovery<span class="h-ribbon h-pos e-green v4">new</span></a></li>
        ...
        <div class="container container-240">
             <div class="single-product-detail product-bundle product-aff">
                        ...
                        <div class="flex product-img-slide">
                            ...
                            <div class="product-images">
                                <div class="main-img js-product-slider">
                                    <a href="#" class="hover-images effect"><img src="img/single/glass1.jpg" alt="photo" class="img-reponsive"></a>
                                    <a href="#" class="hover-images effect"><img src="img/single/glass2.jpg" alt="photo" class="img-reponsive"></a>
                                    <a href="#" class="hover-images effect"><img src="img/single/glass3.jpg" alt="photo" class="img-reponsive"></a>
                                </div>
                            </div>
                            <div class="multiple-img-list-ver2 js-click-product">
                                <div class="product-col">
                                    <div class="img active">
                                        <img src="img/single/glass1.jpg" alt="photo" class="img-reponsive">
                                    </div>
                                </div>
                                <div class="product-col">
                                    <div class="img">
                                        <img src="img/single/glass2.jpg" alt="images" class="img-responsive">
                                    </div>
                                </div>
                                <div class="product-col">
                                    <div class="img">
                                        <img src="img/single/glass3.jpg" alt="images" class="img-responsive">
                                    </div>
                                </div>
                            </div>
                        </div> 
                ...
                <div class="bundle bd-7">
                    <div class="row flex align-center">
                        <div class="col-md-9 col-sm-8 col-xs-12 bdl">
                            <div class="bundle-left">
                                <h3 class="bundle-title spc">Frequently bought together</h3>
                                <div class="bundle-product flex">
                                    <div class="bundle-product-img">
                                        <a class="bd-7 v2 hover-images" href=""><img src="img/single/glass1.jpg" alt="photo" class="img-reponsive"></a>
                                    </div>
                                    <div class="bundle-product-img">
                                        <a class="bd-7 v2 hover-images" href=""><img src="img/single/glass4.jpg" alt="photo" class="img-reponsive"></a>
                                    </div>
                                    <div class="bundle-product-img">
                                        <a class="bd-7 v2 hover-images" href=""><img src="img/single/glass5.jpg" alt="photo" class="img-reponsive"></a>
                                    </div>
                                </div>
                                <div class="product-bundle-list spc">
                                    <input type="checkbox" id="radio1" checked="">
                                    <label for="radio1">This item : B&O PLAY by Bang & Olufsen Beoplay <span class="bundle-price">( $177.95 )</span></label>

                                    <input type="checkbox" id="radio2" checked="">
                                    <label for="radio2">B&O Play Wall Bracket For BeoPlay A9  <span class="bundle-price">( $177.95 )</span></label>

                                    <input type="checkbox" id="radio3" checked="">
                                    <label for="radio3">B&O PLAY by Bang & Olufsen Beoplay A9 Music System Home Speaker Accessory Cover <span class="bundle-price">( $177.95 )</span></label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-4 col-xs-12">
                            <div class="bundle-info text-center">
                                <span class="bundle-price">$1,369.00</span>
                                <p class="bundle-total">for 3 item(s)</p>
                                <a href="#" class="btn-addcart">Add all to cart</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                            <div class="footer-block footer-about">
                                ...
                                <ul class="footer-block-content">
                                    ...
                                    <li class="phone">
                                        <span>(+123) 456 XXX - (+123) 666 XXX</span>
                                    </li>
                                    <li class="email">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
                            <div class="footer-block">
                                ...
                                <ul class="footer-block-content">
                                    ...
                                    <li><a href="#">Unboxing Videos</a></li>
                                    <li><a href="#">Reviews</a></li>
                                    <li><a href="#">Blogs/Latest Updates</a></li>
                                   </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                            <div class="footer-block">
                                <div class="footer-block-phone">
                                    ...
                                    <p class="phone-light">(+123) 456 XXX or (+123) 666 XXX</p>
                                </div>
            ...
            <div class="f-bottom">
                <div class="container container-240">
                    <div class="row flex lr">
                        <div class="col-xs-6 f-copyright"><span>© 2018-2020 NycGames. All rights reserved.</span></div>
