        ...
        <div class="container container-240 shop-collection">
            ...
            <div class="row shop-colect">
                <div class="col-md-3 col-sm-3 col-xs-12 col-left collection-sidebar" id="filter-sidebar">
                    ...
                    <div class="filter filter-cate">
                        <ul class="wiget-content v2">
                            <li class="active"><a href="#">Gaming accessories<span class="number">(80)</span></a></li>
                            <li class="active"><a href="#">Console <span class="number">(80)</span></a></li>
                            <li class="active"><a href="#">Games <span class="number">(80)</span></a></li>
                        </ul>
                    </div>
                ...
                <div class="col-md-9 col-sm-12 col-xs-12 collection-list">
                    <div class="e-product">
                        <div class="pd-banner">
                           <a href="#" class="image-bd effect_img2"><img src="<?php echo base_url(); ?>assets/assets/img/Bundle_offer.png" alt="" class="img-reponsive"></a> 
                        </div>
                        <div class="pd-top">
                        ...
                        <div class="product-collection-grid product-grid">
                            <div class="row">
                                ...
                                <?php
                                if(!empty($bundle_offer))

                                    foreach($bundle_offer as $bundle)
                                        { ?>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 product-item">
                                    <div class="pd-bd product-inner">
                                        <div class="product-img">
                                            <a href="<?= LANG_URL . '/' . $bundle['url'] ?>"><img src="<?= base_url('attachments/shop_images/' . $bundle['image']) ?>" alt="" class="img-reponsive"></a>
                                        </div>
                                        <div class="product-info">
                                            ...
                                            <div class="element-list element-list-left">
                                                <ul class="desc-list">
                                                  ...
                                                  <?= character_limiter(strip_tags($bundle['description']), 50);?>
...
<!--                                                 <div class="product-rating bd-rating">
 ...
 --><!-- 
                                                ...
                                                <h3 class="product-title"><a href="<?= LANG_URL . '/' . $bundle['url'] ?>"><?= character_limiter($bundle['title'], 50);?></a></h3>
                                                <div class="product-bottom">
                                                    <div class="product-price"><span>AED<?php echo $bundle['price']; ?></span></div>
