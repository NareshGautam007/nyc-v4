...
class Public_model extends CI_Model
{
    ...
    public function Gaming_accessories()
    {

        $SQL ="SELECT vendors.url as vendor_url, products_translations.description as description, products.id, products.quantity,products.image,products.url,products_translations.price,products_translations.title,products_translations.old_price FROM products left JOIN vendors ON vendors.id=products.vendor_id 
        LEFT JOIN products_translations ON products_translations.for_id =products.id
         WHERE shop_categorie=30 AND products.in_slider=0 AND  products.feature_product=1  AND visibility=1 ORDER BY ID DESC";
    ...
    public function Game()
    {
        ...
        $SQL ="SELECT vendors.url as vendor_url, products_translations.description as description, products.id, products.quantity,products.image,products.url,products_translations.price,products_translations.title,products_translations.old_price FROM products left JOIN vendors ON vendors.id=products.vendor_id 
        LEFT JOIN products_translations ON products_translations.for_id =products.id
         WHERE shop_categorie=31 AND products.in_slider=0 AND products.feature_product=1 AND visibility=1 ORDER BY ID DESC";
    ...
    public function Console()
    {
        ...
        $SQL ="SELECT vendors.url as vendor_url, products_translations.description as description, products.id, products.quantity,products.image,products.url,products_translations.price,products_translations.title,products_translations.old_price FROM products left JOIN vendors ON vendors.id=products.vendor_id 
        LEFT JOIN products_translations ON products_translations.for_id =products.id
         WHERE shop_categorie=32 AND products.in_slider=0 AND products.feature_product=1 AND visibility=1 ORDER BY ID DESC";
     ...
     public function Super_deal()
    {

        $SQL ="SELECT products.folder as folder, vendors.url as vendor_url, products_translations.description as description, products.id, products.quantity,products.image,products.url,products_translations.price,products_translations.title,products_translations.old_price FROM products left JOIN vendors ON vendors.id=products.vendor_id 
        LEFT JOIN products_translations ON products_translations.for_id =products.id
         WHERE  products.in_slider=0 AND visibility=1 AND products.super_deal=1 ORDER BY ID DESC";
      ...
      public function Best_Gaming_accessories()
    {

        $SQL ="SELECT vendors.url as vendor_url, products_translations.description as description, products.id, products.quantity,products.image,products.url,products_translations.price,products_translations.title,products_translations.old_price FROM products left JOIN vendors ON vendors.id=products.vendor_id 
        LEFT JOIN products_translations ON products_translations.for_id =products.id
         WHERE shop_categorie=30 AND products.in_slider=0 AND products.best_seller=1 AND visibility=1 ORDER BY ID DESC";
      ...
      public function Best_Gaming()
    {

        $SQL ="SELECT vendors.url as vendor_url, products_translations.description as description, products.id, products.quantity,products.image,products.url,products_translations.price,products_translations.title,products_translations.old_price FROM products left JOIN vendors ON vendors.id=products.vendor_id 
        LEFT JOIN products_translations ON products_translations.for_id =products.id
         WHERE shop_categorie=31 AND products.in_slider=0 AND products.best_seller=1 AND visibility=1 ORDER BY ID DESC";
     ...
     public function Best_Console()
    {

        $SQL ="SELECT vendors.url as vendor_url, products_translations.description as description, products.id, products.quantity,products.image,products.url,products_translations.price,products_translations.title,products_translations.old_price FROM products left JOIN vendors ON vendors.id=products.vendor_id 
        LEFT JOIN products_translations ON products_translations.for_id =products.id
         WHERE shop_categorie=32 AND products.in_slider=0 AND products.best_seller=1 AND visibility=1 ORDER BY ID DESC";
    ...
    public function Get_category($cat_id){
        ...
        LEFT JOIN products_translations ON products_translations.for_id =products.id
         WHERE  products.in_slider=0 AND shop_categorie=$cat_id AND visibility=1 ORDER BY ID DESC";
    ...
    public function Bundle_offer(){
        ...
        $SQL= "SELECT vendors.url as vendor_url, products_translations.description as description, products.id, products.quantity,products.image,products.url,products_translations.price,products_translations.title,products_translations.old_price FROM products left JOIN vendors ON vendors.id=products.vendor_id 
        LEFT JOIN products_translations ON products_translations.for_id =products.id
         WHERE  products.in_slider=0 AND products.bundle_offer=1 AND visibility=1 ORDER BY ID DESC";
         $query = $this->db->query($SQL);
         $bundle_offer = $query->result_array();
         return $bundle_offer;
    }
    
    public function feature_console()
    {
