...
?>
<div class="row ghj">
    <div class="col-sm-6 ghj1">
        <form method="GET">
            <div class="input-group">
                <input type="text" class="form-control bdrs" name="search" value="<?= @$_GET['search'] ?>" placeholder="Find here">
                <span class="input-group-btn">
                    <button class="btn btn-default srcb" type="submit"><i class="fa fa-search" aria-hidden="true"></i>
</button>
                </span>
            </div>
        ...
        foreach ($posts as $row) {
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h3><a href="<?= base_url($row['url']) ?>" target="_blank"><?= character_limiter($row['title'], 90) ?></a></h3>
                        <a href="<?= base_url('admin/blogpublish/' . $row['id']) ?>" class="btn btn-primary edbtn" role="button">Edit</a>
