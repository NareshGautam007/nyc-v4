<div id="users">
    ...
    ?>
    <a href="javascript:void(0);" data-toggle="modal" data-target="#add_edit_users" class="btn btn-primary btn-xs pull-right bcv" style="margin-bottom:10px;"><b>+</b> Add new user</a>
