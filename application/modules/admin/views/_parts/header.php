        ...
        <div id="wrapper">
            <div id="content">
                <?php if ($this->session->userdata('logged_in')) { ?>
                    <nav class="navbar navbar-default csthdr">
                        ...
                        <div id="navbar" class="collapse navbar-collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="<?= base_url() ?>" target="_blank"><i class="glyphicon glyphicon-star"></i> Website</a></li>
                                <li>
                                    <a href="javascript:void(0);" class="h-settings"><i class="fa fa-key" aria-hidden="true"></i> Pass Change</a>
                                    <div class="relative">
                                        <div class="settings passd">
                                            <div class="panel panel-primary" >
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <form class="form-inline" role="form">
                                                        ...
                                                        <a href="javascript:void(0);" onclick="changePass()" class="btn btn-sm btn-primary nycbtn">Update</a>
                                                        <hr>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <?php if ($this->session->userdata('logged_in')) { ?>
                            <div class="col-sm-3 col-md-3 col-lg-2 left-side navbar-default csthdrl">
                                <div class="show-menu">
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li><a href="<?= base_url('admin/publish') ?>" <?= urldecode(uri_string()) == 'admin/publish' ? 'class="active"' : '' ?>><i class="fa fa-edit" aria-hidden="true"></i> Add product</a></li>
                                    <li><a href="<?= base_url('admin/products') ?>" <?= urldecode(uri_string()) == 'admin/products' ? 'class="active"' : '' ?>><i class="fa fa-files-o" aria-hidden="true"></i>List Products</a></li>
                                    <?php if ($showBrands == 1) { ?>
