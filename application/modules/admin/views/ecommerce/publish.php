...
<form method="POST" action="" enctype="multipart/form-data">
    ...
    foreach ($languages as $language) {
        ?>
        <div class="locale-container row locale-container-<?= $language->abbr ?>" <?= $language->abbr == MY_DEFAULT_LANGUAGE_ABBR ? 'style="display:block;"' : '' ?>>
    ...
    ?>
    <div class="form-group bordered-group col-md-12">
        <?php
    ...
    <div class="form-group for-shop col-md-12 pdnc">
    ...
    <?php if ($showBrands == 1) { ?>
        <div class="form-group for-shop col-md-12">
            <label>Brand</label>
    ...
    <div class="form-group for-shop">
    <div class="col-md-3">
    <label>Super Deal</label>
        <input type="checkbox"  name="super_deal" value="1" > 
    </div>

    <div class="col-md-3">
    <label>Featuer Product</label>
    ...
    <label>Bundle Offer</label>
        <input type="checkbox"  name="bundle_offer" value="1"  >
    </div>
    ...
    <?php if ($this->uri->segment(3) !== null) { ?>
        <a href="<?= base_url('admin/products') ?>" class="btn btn-lg btn-default cnclbtn">Cancel</a>
    <?php } ?>
</form>
