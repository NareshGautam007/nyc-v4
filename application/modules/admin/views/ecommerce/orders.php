...
if (!isset($_GET['settings'])) {
    if (!empty($orders)) {
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    ...
                                                    foreach ($arr_products as $product) {
                                                        ...
                                                        <div style="word-break: break-all;">
                                                            ...
                                                            <a data-toggle="tooltip" data-placement="top" title="Click to preview" target="_blank" href="<?= base_url($product['product_info']['url']) ?>">
                                                                ...
                                                                <div style=" background-color: #f1f1f1; border-radius: 2px; padding: 2px 5px;">
                                                                    ...
                                                                    <b>Price: AED <?= $product['product_info']['price']; ?></b>
                                                                </div>
                                                            </a>
                                                            <div class="">
                                                                <b>Vendor:</b>
                                                        ...
                                                        <div style="padding-top:10px; font-size:16px;">Total amount of products: AED <?= $total_amount; ?></div>
                                                        <hr>
                                                    <?php }
                                                    ?>
                                                </td>
        ...
        <?= $links_pagination ?>
    <?php } else { ?>
        <div class="alert alert-info">No orders at the moment!</div>
    <?php }
    ?>        
    <hr>
    <?php
...
if (isset($_GET['settings'])) {
    ?>
    <h3 class="odsh">Cash On Delivery</h3>
    <div class="row">
        <div class="col-sm-12">
    ...
    <hr>
    <h3 class="odsh1">Paypal Account Settings</h3>
    <div class="row">
        <div class="col-sm-6">
            <div class="panel panel-default">
    ...
    <hr>
    <h3 class="odsh1">Bank Account Settings</h3>
    <div class="row">
        <div class="col-sm-12">
            ...
            <form method="POST" action="">
                ...
                <input type="submit" class="form-control odssbtn" value="Save Bank Account Settings">
            </form>
        </div>
    </div>
<?php } ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel" style="color:white;">Preview <b id="client-name"></b></h4>
            </div>
