        ...
        <div class="col-xs-12">
            ...
            if ($products) {
                ...
                <div class="table-responsive">
                    <table class="table table-bordered alg">
                        <thead>
                            <tr>
                                <th>Image</th>
                                <th>Title</th>
                        ...
                        <tbody>
                            ...
                            foreach ($products as $row) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $row->position ?></td>
                                    <td>
                                        <div class="pull-right btncs">
                                            <a href="<?= base_url('admin/publish/' . $row->id) ?>" class="btn btn-info edbt">Edit</a>
                                            <a href="<?= base_url('admin/products?delete=' . $row->id) ?>"  class="btn btn-danger confirm-delete1">Delete</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php
